...
**Status:** first-pass draft. Not reviewed by a lawyer, not published anywhere in the app, not
linked from sign-up. Do not treat this as binding or ship it to a real member until a lawyer has
reviewed it, the same gate this repo already applies to the Stage 10 credit-consent copy (see
PROJECT.md, issue #286).
**Date:** 2026-09-08.
...
[NEEDS PRODUCT/LEGAL INPUT: a real privacy/support contact address. None exists in the codebase or
PROJECT.md today.]
