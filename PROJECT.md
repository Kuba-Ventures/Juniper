...
- `VITE_PLAID_LAYER` (frontend, optional) — set to `1` to mount the `LayerDiscovery` phone-entry step in onboarding + Connections; off by default so the seam stays inert until Layer is configured
