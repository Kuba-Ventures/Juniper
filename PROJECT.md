...
- [ ] **Account discovery (Stage 13)** — apply migration `0014_manual_accounts`; fold manual balances into net worth / the account rollup (`_finance-snapshot.ts` + `/api/finances`); at Plaid Production, create a Layer template, set `PLAID_LAYER_TEMPLATE_ID` + `VITE_PLAID_LAYER=1`, and verify Layer's multi-item exchange end-to-end — Finley
